...
Turning 1 million forward pass into 1 backward pass, as we know each nodes $\frac{ \partial \mathcal{L} }{ \partial w_{\text{current node}} }$ as we move backwards all the way to the first node (wherever).

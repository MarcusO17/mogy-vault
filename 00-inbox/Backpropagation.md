...
And the aforementioned inputs are the previous nodes activations (in simpler terms, their output) which is denoted as $z$ (similar to net input). The formula for net input:
$$
	z = wx+b
$$
To see how much th

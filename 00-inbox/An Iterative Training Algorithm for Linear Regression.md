...
To naively train a [[Linear Regression|linear regression model]], We could start by initializing the parameters to 0 or (any random small value) then.
...
This is rather similar to the [[The Perceptron#Perceptron Learning Algorithm|perceptron learning algorithm]], we utilize [[concepts/deep-learning/training/Stochastic Gradient Descent | Stochastic Gradient Descent]]
---
title: An Iterative Training Algorithm for Linear Regression
course: rasbt-Introduction to Deep Learning
lecture: L5.3
